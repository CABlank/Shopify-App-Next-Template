interface CUSTOMERS_MERGE_errors {
    customer_ids: Array<number>;
    field: string;
    message: string;
}
interface CUSTOMERS_MERGE {
...
interface SUBSCRIPTION_BILLING_ATTEMPTS_CHALLENGED {
    id: null | string;
...
interface FULFILLMENT_ORDERS_HOLD_RELEASED_fulfillment_order {
    id: string;
    status: string;
}
interface FULFILLMENT_ORDERS_HOLD_RELEASED {
    fulfillment_order: FULFILLMENT_ORDERS_HOLD_RELEASED_fulfillment_order;
}
interface FULFILLMENT_ORDERS_FULFILLMENT_SERVICE_FAILED_TO_COMPLETE_fulfillment_order {
    id: string;
    status: string;
}
interface FULFILLMENT_ORDERS_FULFILLMENT_SERVICE_FAILED_TO_COMPLETE {
...
interface PRODUCT_FEEDS_FULL_SYNC_metadata {
    action: string;
    type: string;
    resource: string;
    fullSyncId: string;
...
interface PRODUCT_FEEDS_FULL_SYNC_productFeed {
    id: string;
    shop_id: string;
    language: string;
    country: string;
}
interface PRODUCT_FEEDS_FULL_SYNC_fullSync {
    createdAt: string;
    errorCode: string;
    status: string;
    count: number;
}
interface PRODUCT_FEEDS_FULL_SYNC {
...
interface ORDERS_PAID_current_subtotal_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_current_subtotal_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_current_subtotal_price_set {
...
interface ORDERS_PAID_current_total_discounts_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_current_total_discounts_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_current_total_discounts_set {
...
interface ORDERS_PAID_current_total_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_current_total_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_current_total_price_set {
...
interface ORDERS_PAID_current_total_tax_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_current_total_tax_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_current_total_tax_set {
...
interface ORDERS_PAID_subtotal_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_subtotal_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_subtotal_price_set {
    shop_money: ORDERS_PAID_subtotal_price_set_shop_money;
    presentment_money: ORDERS_PAID_subtotal_price_set_presentment_money;
}
interface ORDERS_PAID_total_discounts_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_total_discounts_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_total_discounts_set {
    shop_money: ORDERS_PAID_total_discounts_set_shop_money;
    presentment_money: ORDERS_PAID_total_discounts_set_presentment_money;
}
interface ORDERS_PAID_total_line_items_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_total_line_items_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_total_line_items_price_set {
...
interface ORDERS_PAID_total_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_total_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_total_price_set {
    shop_money: ORDERS_PAID_total_price_set_shop_money;
    presentment_money: ORDERS_PAID_total_price_set_presentment_money;
}
interface ORDERS_PAID_total_shipping_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_total_shipping_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_total_shipping_price_set {
...
interface ORDERS_PAID_total_tax_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_total_tax_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_total_tax_set {
    shop_money: ORDERS_PAID_total_tax_set_shop_money;
    presentment_money: ORDERS_PAID_total_tax_set_presentment_money;
}
interface ORDERS_PAID_billing_address {
    first_name: string;
    address1: string;
    phone: string;
    city: string;
...
interface ORDERS_PAID_customer_email_marketing_consent {
    state: string;
    opt_in_level: null | string;
    consent_updated_at: null | string;
}
interface ORDERS_PAID_customer_default_address {
    id: number;
    customer_id: number;
...
interface ORDERS_PAID_customer {
    id: number;
    email: string;
...
interface ORDERS_PAID_line_items_attributed_staffs {
    id: string;
    quantity: number;
}
interface ORDERS_PAID_line_items_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_line_items_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_line_items_price_set {
...
interface ORDERS_PAID_line_items_total_discount_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_line_items_total_discount_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_line_items_total_discount_set {
...
interface ORDERS_PAID_line_items {
    id: number;
    admin_graphql_api_id: string;
...
interface ORDERS_PAID_shipping_address {
    first_name: string;
    address1: string;
    phone: string;
    city: string;
...
interface ORDERS_PAID_shipping_lines_discounted_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_shipping_lines_discounted_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_shipping_lines_discounted_price_set {
...
interface ORDERS_PAID_shipping_lines_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_shipping_lines_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PAID_shipping_lines_price_set {
...
interface ORDERS_PAID_shipping_lines {
    id: number;
...
interface COMPANY_CONTACTS_CREATE_company {
    name: string;
    note: string;
    external_id: string;
    main_contact_admin_graphql_api_id: string;
...
interface COMPANY_CONTACTS_CREATE {
...
interface ORDERS_EDITED_order_edit_line_items_additions {
    id: number;
    delta: number;
}
interface ORDERS_EDITED_order_edit_line_items_removals {
    id: number;
    delta: number;
}
interface ORDERS_EDITED_order_edit_line_items {
    additions: Array<ORDERS_EDITED_order_edit_line_items_additions>;
    removals: Array<ORDERS_EDITED_order_edit_line_items_removals>;
}
interface ORDERS_EDITED_order_edit_discounts_line_item {
    additions: Array<any>;
    removals: Array<any>;
}
interface ORDERS_EDITED_order_edit_discounts {
    line_item: ORDERS_EDITED_order_edit_discounts_line_item;
}
interface ORDERS_EDITED_order_edit_shipping_lines {
    additions: Array<any>;
}
interface ORDERS_EDITED_order_edit {
    id: number;
    app_id: null | string;
    created_at: string;
...
interface ORDERS_EDITED {
    order_edit: ORDERS_EDITED_order_edit;
}
interface PAYMENT_SCHEDULES_DUE {
    id: number;
...
interface APP_PURCHASES_ONE_TIME_UPDATE_app_purchase_one_time {
    admin_graphql_api_id: string;
    name: string;
    status: string;
...
interface APP_PURCHASES_ONE_TIME_UPDATE {
    app_purchase_one_time: APP_PURCHASES_ONE_TIME_UPDATE_app_purchase_one_time;
}
interface SELLING_PLAN_GROUPS_CREATE_selling_plans_billing_policy {
    interval: string;
    interval_count: number;
    min_cycles: null | string;
    max_cycles: null | string;
}
interface SELLING_PLAN_GROUPS_CREATE_selling_plans_delivery_policy {
    interval: string;
    interval_count: number;
    anchors: Array<any>;
    cutoff: null | string;
...
interface SELLING_PLAN_GROUPS_CREATE_selling_plans {
    name: string;
...
interface SELLING_PLAN_GROUPS_CREATE {
    admin_graphql_api_id: string;
    id: number;
    name: string;
...
interface COMPANY_LOCATIONS_DELETE_company {
    name: string;
    note: string;
    external_id: string;
    main_contact_admin_graphql_api_id: string;
...
interface COMPANY_LOCATIONS_DELETE_billing_address {
    address1: string;
    city: string;
    province: string;
    country: string;
...
interface COMPANY_LOCATIONS_DELETE_shipping_address {
    address1: string;
    city: string;
    province: string;
    country: string;
...
interface COMPANY_LOCATIONS_DELETE_tax_registration {
    tax_id: string;
}
interface COMPANY_LOCATIONS_DELETE {
    name: string;
    external_id: string;
    phone: string;
    locale: string;
...
interface ORDERS_FULFILLED_current_subtotal_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_current_subtotal_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_current_subtotal_price_set {
...
interface ORDERS_FULFILLED_current_total_discounts_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_current_total_discounts_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_current_total_discounts_set {
...
interface ORDERS_FULFILLED_current_total_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_current_total_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_current_total_price_set {
...
interface ORDERS_FULFILLED_current_total_tax_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_current_total_tax_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_current_total_tax_set {
...
interface ORDERS_FULFILLED_subtotal_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_subtotal_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_subtotal_price_set {
...
interface ORDERS_FULFILLED_total_discounts_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_total_discounts_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_total_discounts_set {
...
interface ORDERS_FULFILLED_total_line_items_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_total_line_items_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_total_line_items_price_set {
...
interface ORDERS_FULFILLED_total_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_total_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_total_price_set {
...
interface ORDERS_FULFILLED_total_shipping_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_total_shipping_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_total_shipping_price_set {
...
interface ORDERS_FULFILLED_total_tax_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_total_tax_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_total_tax_set {
    shop_money: ORDERS_FULFILLED_total_tax_set_shop_money;
    presentment_money: ORDERS_FULFILLED_total_tax_set_presentment_money;
}
interface ORDERS_FULFILLED_billing_address {
    first_name: string;
    address1: string;
    phone: string;
    city: string;
...
interface ORDERS_FULFILLED_customer_email_marketing_consent {
    state: string;
    opt_in_level: null | string;
    consent_updated_at: null | string;
}
interface ORDERS_FULFILLED_customer_default_address {
    id: number;
    customer_id: number;
    first_name: null | string;
    last_name: null | string;
...
interface ORDERS_FULFILLED_customer {
    id: number;
    email: string;
    accepts_marketing: boolean;
    created_at: null | string;
...
interface ORDERS_FULFILLED_line_items_attributed_staffs {
    id: string;
    quantity: number;
}
interface ORDERS_FULFILLED_line_items_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_line_items_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_line_items_price_set {
...
interface ORDERS_FULFILLED_line_items_total_discount_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_line_items_total_discount_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_line_items_total_discount_set {
...
interface ORDERS_FULFILLED_line_items {
    id: number;
    admin_graphql_api_id: string;
...
interface ORDERS_FULFILLED_shipping_address {
    first_name: string;
    address1: string;
    phone: string;
    city: string;
...
interface ORDERS_FULFILLED_shipping_lines_discounted_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_shipping_lines_discounted_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_shipping_lines_discounted_price_set {
...
interface ORDERS_FULFILLED_shipping_lines_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_shipping_lines_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_FULFILLED_shipping_lines_price_set {
...
interface ORDERS_FULFILLED_shipping_lines {
    id: number;
    carrier_identifier: null | string;
    code: null | string;
    discounted_price: string;
...
interface FULFILLMENT_ORDERS_LINE_ITEMS_PREPARED_FOR_PICKUP_fulfillment_order_delivery_method {
    method_type: string;
}
interface FULFILLMENT_ORDERS_LINE_ITEMS_PREPARED_FOR_PICKUP_fulfillment_order {
    id: string;
    status: string;
    preparable: boolean;
    delivery_method: FULFILLMENT_ORDERS_LINE_ITEMS_PREPARED_FOR_PICKUP_fulfillment_order_delivery_method;
}
interface FULFILLMENT_ORDERS_LINE_ITEMS_PREPARED_FOR_PICKUP {
    fulfillment_order: FULFILLMENT_ORDERS_LINE_ITEMS_PREPARED_FOR_PICKUP_fulfillment_order;
}
interface ORDERS_PARTIALLY_FULFILLED_current_subtotal_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_current_subtotal_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_current_subtotal_price_set {
...
interface ORDERS_PARTIALLY_FULFILLED_current_total_discounts_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_current_total_discounts_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_current_total_discounts_set {
...
interface ORDERS_PARTIALLY_FULFILLED_current_total_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_current_total_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_current_total_price_set {
...
interface ORDERS_PARTIALLY_FULFILLED_current_total_tax_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_current_total_tax_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_current_total_tax_set {
...
interface ORDERS_PARTIALLY_FULFILLED_subtotal_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_subtotal_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_subtotal_price_set {
...
interface ORDERS_PARTIALLY_FULFILLED_total_discounts_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_total_discounts_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_total_discounts_set {
...
interface ORDERS_PARTIALLY_FULFILLED_total_line_items_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_total_line_items_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_total_line_items_price_set {
...
interface ORDERS_PARTIALLY_FULFILLED_total_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_total_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_total_price_set {
...
interface ORDERS_PARTIALLY_FULFILLED_total_shipping_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_total_shipping_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_total_shipping_price_set {
...
interface ORDERS_PARTIALLY_FULFILLED_total_tax_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_total_tax_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_total_tax_set {
...
interface ORDERS_PARTIALLY_FULFILLED_billing_address {
    first_name: string;
    address1: string;
    phone: string;
    city: string;
...
interface ORDERS_PARTIALLY_FULFILLED_customer_email_marketing_consent {
    state: string;
    opt_in_level: null | string;
    consent_updated_at: null | string;
}
interface ORDERS_PARTIALLY_FULFILLED_customer_default_address {
    id: number;
    customer_id: number;
    first_name: null | string;
    last_name: null | string;
...
interface ORDERS_PARTIALLY_FULFILLED_customer {
    id: number;
    email: string;
    accepts_marketing: boolean;
    created_at: null | string;
...
interface ORDERS_PARTIALLY_FULFILLED_line_items_attributed_staffs {
    id: string;
    quantity: number;
}
interface ORDERS_PARTIALLY_FULFILLED_line_items_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_line_items_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_line_items_price_set {
...
interface ORDERS_PARTIALLY_FULFILLED_line_items_total_discount_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_line_items_total_discount_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_line_items_total_discount_set {
...
interface ORDERS_PARTIALLY_FULFILLED_line_items {
    id: number;
    admin_graphql_api_id: string;
...
interface ORDERS_PARTIALLY_FULFILLED_shipping_address {
    first_name: string;
    address1: string;
    phone: string;
    city: string;
...
interface ORDERS_PARTIALLY_FULFILLED_shipping_lines_discounted_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_shipping_lines_discounted_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_shipping_lines_discounted_price_set {
...
interface ORDERS_PARTIALLY_FULFILLED_shipping_lines_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_shipping_lines_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_PARTIALLY_FULFILLED_shipping_lines_price_set {
...
interface ORDERS_PARTIALLY_FULFILLED_shipping_lines {
    id: number;
    carrier_identifier: null | string;
    code: null | string;
    discounted_price: string;
...
interface FULFILLMENT_EVENTS_CREATE {
    id: number;
...
interface CUSTOMER_GROUPS_CREATE {
    id: number;
    name: string;
    created_at: string;
    updated_at: string;
...
interface MARKETS_UPDATE_regions {
    country_code: string;
}
interface MARKETS_UPDATE {
    id: number;
    name: string;
    enabled: boolean;
    regions: Array<MARKETS_UPDATE_regions>;
}
interface DRAFT_ORDERS_CREATE_line_items {
    id: number;
    variant_id: number;
    product_id: number;
    title: string;
...
interface DRAFT_ORDERS_CREATE_shipping_address {
    first_name: string;
    address1: string;
    phone: string;
    city: string;
...
interface DRAFT_ORDERS_CREATE_billing_address {
    first_name: string;
    address1: string;
    phone: string;
    city: string;
...
interface DRAFT_ORDERS_CREATE_applied_discount {
    description: string;
    value: string;
    title: string;
    amount: string;
...
interface DRAFT_ORDERS_CREATE_shipping_line {
    title: string;
    custom: boolean;
    handle: null | string;
    price: string;
}
interface DRAFT_ORDERS_CREATE_tax_lines {
    rate: number;
    title: string;
    price: string;
}
interface DRAFT_ORDERS_CREATE_payment_terms_payment_schedules {
    id: number;
    created_at: string;
    updated_at: string;
    payment_terms_id: number;
...
interface DRAFT_ORDERS_CREATE_payment_terms {
    id: number;
...
interface DRAFT_ORDERS_CREATE_customer_email_marketing_consent {
    state: string;
    opt_in_level: null | string;
    consent_updated_at: null | string;
}
interface DRAFT_ORDERS_CREATE_customer_default_address {
    id: null | string;
    customer_id: number;
    first_name: null | string;
    last_name: null | string;
...
interface DRAFT_ORDERS_CREATE_customer {
    id: number;
    email: string;
    accepts_marketing: boolean;
    created_at: null | string;
...
interface ORDERS_CREATE_current_subtotal_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_current_subtotal_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_current_subtotal_price_set {
...
interface ORDERS_CREATE_current_total_discounts_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_current_total_discounts_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_current_total_discounts_set {
...
interface ORDERS_CREATE_current_total_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_current_total_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_current_total_price_set {
...
interface ORDERS_CREATE_current_total_tax_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_current_total_tax_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_current_total_tax_set {
...
interface ORDERS_CREATE_subtotal_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_subtotal_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_subtotal_price_set {
...
interface ORDERS_CREATE_total_discounts_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_total_discounts_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_total_discounts_set {
...
interface ORDERS_CREATE_total_line_items_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_total_line_items_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_total_line_items_price_set {
...
interface ORDERS_CREATE_total_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_total_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_total_price_set {
    shop_money: ORDERS_CREATE_total_price_set_shop_money;
    presentment_money: ORDERS_CREATE_total_price_set_presentment_money;
}
interface ORDERS_CREATE_total_shipping_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_total_shipping_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_total_shipping_price_set {
...
interface ORDERS_CREATE_total_tax_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_total_tax_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_total_tax_set {
    shop_money: ORDERS_CREATE_total_tax_set_shop_money;
    presentment_money: ORDERS_CREATE_total_tax_set_presentment_money;
}
interface ORDERS_CREATE_billing_address {
    first_name: string;
    address1: string;
    phone: string;
    city: string;
...
interface ORDERS_CREATE_customer_email_marketing_consent {
    state: string;
    opt_in_level: null | string;
    consent_updated_at: null | string;
}
interface ORDERS_CREATE_customer_default_address {
    id: number;
    customer_id: number;
    first_name: null | string;
    last_name: null | string;
...
interface ORDERS_CREATE_customer {
    id: number;
    email: string;
    accepts_marketing: boolean;
    created_at: null | string;
...
interface ORDERS_CREATE_line_items_attributed_staffs {
    id: string;
    quantity: number;
}
interface ORDERS_CREATE_line_items_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_line_items_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_line_items_price_set {
...
interface ORDERS_CREATE_line_items_total_discount_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_line_items_total_discount_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_line_items_total_discount_set {
...
interface ORDERS_CREATE_line_items {
    id: number;
    admin_graphql_api_id: string;
...
interface ORDERS_CREATE_shipping_address {
    first_name: string;
    address1: string;
    phone: string;
    city: string;
...
interface ORDERS_CREATE_shipping_lines_discounted_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_shipping_lines_discounted_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_shipping_lines_discounted_price_set {
...
interface ORDERS_CREATE_shipping_lines_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_shipping_lines_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CREATE_shipping_lines_price_set {
...
interface ORDERS_CREATE_shipping_lines {
    id: number;
    carrier_identifier: null | string;
    code: null | string;
    discounted_price: string;
...
interface DOMAINS_DESTROY_localization {
    country: null | string;
    default_locale: string;
    alternate_locales: Array<any>;
}
interface DOMAINS_DESTROY {
    id: number;
    host: string;
    ssl_enabled: boolean;
    localization: DOMAINS_DESTROY_localization;
}
interface FULFILLMENT_ORDERS_MOVED_original_fulfillment_order {
    id: string;
    status: string;
    assigned_location_id: string;
}
interface FULFILLMENT_ORDERS_MOVED_moved_fulfillment_order {
    id: string;
    status: string;
    assigned_location_id: string;
}
interface FULFILLMENT_ORDERS_MOVED_fulfillment_order_line_items_requested {
    id: string;
    quantity: number;
}
interface FULFILLMENT_ORDERS_MOVED_source_location {
    id: string;
}
interface FULFILLMENT_ORDERS_MOVED {
...
interface APP_SUBSCRIPTIONS_APPROACHING_CAPPED_AMOUNT_app_subscription {
    admin_graphql_api_id: string;
    name: string;
    balance_used: number;
...
interface APP_SUBSCRIPTIONS_APPROACHING_CAPPED_AMOUNT {
    app_subscription: APP_SUBSCRIPTIONS_APPROACHING_CAPPED_AMOUNT_app_subscription;
}
interface ORDERS_UPDATED_current_subtotal_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_current_subtotal_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_current_subtotal_price_set {
...
interface ORDERS_UPDATED_current_total_discounts_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_current_total_discounts_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_current_total_discounts_set {
...
interface ORDERS_UPDATED_current_total_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_current_total_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_current_total_price_set {
...
interface ORDERS_UPDATED_current_total_tax_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_current_total_tax_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_current_total_tax_set {
...
interface ORDERS_UPDATED_subtotal_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_subtotal_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_subtotal_price_set {
...
interface ORDERS_UPDATED_total_discounts_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_total_discounts_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_total_discounts_set {
...
interface ORDERS_UPDATED_total_line_items_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_total_line_items_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_total_line_items_price_set {
...
interface ORDERS_UPDATED_total_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_total_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_total_price_set {
    shop_money: ORDERS_UPDATED_total_price_set_shop_money;
    presentment_money: ORDERS_UPDATED_total_price_set_presentment_money;
}
interface ORDERS_UPDATED_total_shipping_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_total_shipping_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_total_shipping_price_set {
...
interface ORDERS_UPDATED_total_tax_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_total_tax_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_total_tax_set {
    shop_money: ORDERS_UPDATED_total_tax_set_shop_money;
    presentment_money: ORDERS_UPDATED_total_tax_set_presentment_money;
}
interface ORDERS_UPDATED_billing_address {
    first_name: string;
    address1: string;
    phone: string;
    city: string;
...
interface ORDERS_UPDATED_customer_email_marketing_consent {
    state: string;
    opt_in_level: null | string;
    consent_updated_at: null | string;
}
interface ORDERS_UPDATED_customer_default_address {
    id: number;
    customer_id: number;
    first_name: null | string;
    last_name: null | string;
...
interface ORDERS_UPDATED_customer {
    id: number;
    email: string;
    accepts_marketing: boolean;
    created_at: null | string;
...
interface ORDERS_UPDATED_line_items_attributed_staffs {
    id: string;
    quantity: number;
}
interface ORDERS_UPDATED_line_items_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_line_items_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_line_items_price_set {
...
interface ORDERS_UPDATED_line_items_total_discount_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_line_items_total_discount_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_line_items_total_discount_set {
...
interface ORDERS_UPDATED_line_items {
    id: number;
    admin_graphql_api_id: string;
...
interface ORDERS_UPDATED_shipping_address {
    first_name: string;
    address1: string;
    phone: string;
    city: string;
...
interface ORDERS_UPDATED_shipping_lines_discounted_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_shipping_lines_discounted_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_shipping_lines_discounted_price_set {
...
interface ORDERS_UPDATED_shipping_lines_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_shipping_lines_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_UPDATED_shipping_lines_price_set {
...
interface ORDERS_UPDATED_shipping_lines {
    id: number;
    carrier_identifier: null | string;
    code: null | string;
    discounted_price: string;
...
interface ORDER_TRANSACTIONS_CREATE_payment_details {
...
interface ORDER_TRANSACTIONS_CREATE_total_unsettled_set_presentment_money {
    amount: string;
    currency: string;
}
interface ORDER_TRANSACTIONS_CREATE_total_unsettled_set_shop_money {
    amount: string;
    currency: string;
}
interface ORDER_TRANSACTIONS_CREATE_total_unsettled_set {
...
interface ORDER_TRANSACTIONS_CREATE {
    id: number;
    order_id: number;
    kind: string;
    gateway: string;
...
interface DOMAINS_CREATE_localization {
    country: null | string;
    default_locale: string;
    alternate_locales: Array<any>;
}
interface DOMAINS_CREATE {
    id: number;
    host: string;
    ssl_enabled: boolean;
    localization: DOMAINS_CREATE_localization;
}
interface FULFILLMENTS_CREATE_destination {
    first_name: string;
    address1: string;
    phone: string;
    city: string;
...
interface FULFILLMENTS_CREATE_line_items_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface FULFILLMENTS_CREATE_line_items_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface FULFILLMENTS_CREATE_line_items_price_set {
...
interface FULFILLMENTS_CREATE_line_items_total_discount_set_shop_money {
    amount: string;
    currency_code: string;
}
interface FULFILLMENTS_CREATE_line_items_total_discount_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface FULFILLMENTS_CREATE_line_items_total_discount_set {
...
interface FULFILLMENTS_CREATE_line_items {
    id: number;
    variant_id: number;
    title: string;
    quantity: number;
...
interface SCHEDULED_PRODUCT_LISTINGS_ADD_scheduled_product_listing_variants_option_values {
    option_id: number;
    name: string;
    value: string;
}
interface SCHEDULED_PRODUCT_LISTINGS_ADD_scheduled_product_listing_variants {
    id: number;
    title: string;
...
interface SCHEDULED_PRODUCT_LISTINGS_ADD_scheduled_product_listing_images {
    id: number;
    created_at: null | string;
    position: number;
    updated_at: null | string;
...
interface SCHEDULED_PRODUCT_LISTINGS_ADD_scheduled_product_listing_options {
    id: number;
    name: string;
    product_id: number;
    position: number;
...
interface SCHEDULED_PRODUCT_LISTINGS_ADD_scheduled_product_listing {
    product_id: number;
    created_at: null | string;
    updated_at: string;
    body_html: string;
...
interface SCHEDULED_PRODUCT_LISTINGS_ADD {
    scheduled_product_listing: SCHEDULED_PRODUCT_LISTINGS_ADD_scheduled_product_listing;
}
interface PROFILES_DELETE {
    id: number;
}
interface PRODUCTS_DELETE {
    id: number;
}
interface CHECKOUTS_UPDATE_line_items {
...
interface CHECKOUTS_UPDATE_billing_address {
    first_name: string;
    address1: string;
    phone: string;
    city: string;
...
interface CHECKOUTS_UPDATE_shipping_address {
    first_name: string;
    address1: string;
    phone: string;
    city: string;
...
interface CHECKOUTS_UPDATE_customer_email_marketing_consent {
    state: string;
    opt_in_level: null | string;
    consent_updated_at: null | string;
}
interface CHECKOUTS_UPDATE_customer_default_address {
    id: null | string;
    customer_id: number;
    first_name: null | string;
    last_name: null | string;
...
interface CHECKOUTS_UPDATE_customer {
    id: number;
    email: string;
    accepts_marketing: boolean;
    created_at: null | string;
...
interface APP_SUBSCRIPTIONS_UPDATE_app_subscription {
    admin_graphql_api_id: string;
    name: string;
    status: string;
    admin_graphql_api_shop_id: string;
...
interface APP_SUBSCRIPTIONS_UPDATE {
    app_subscription: APP_SUBSCRIPTIONS_UPDATE_app_subscription;
}
interface SUBSCRIPTION_BILLING_CYCLE_EDITS_DELETE {
    subscription_contract_id: number;
...
interface FULFILLMENT_ORDERS_FULFILLMENT_REQUEST_REJECTED_fulfillment_order {
    id: string;
    status: string;
    request_status: string;
}
interface FULFILLMENT_ORDERS_FULFILLMENT_REQUEST_REJECTED {
    fulfillment_order: FULFILLMENT_ORDERS_FULFILLMENT_REQUEST_REJECTED_fulfillment_order;
    message: string;
}
interface CUSTOMER_PAYMENT_METHODS_UPDATE_payment_instrument {
    last_digits: string;
    month: number;
    year: number;
    name: string;
...
interface CUSTOMER_PAYMENT_METHODS_UPDATE {
    admin_graphql_api_id: string;
    token: string;
    customer_id: number;
...
interface COLLECTION_LISTINGS_ADD_collection_listing {
...
interface COLLECTION_LISTINGS_ADD {
    collection_listing: COLLECTION_LISTINGS_ADD_collection_listing;
}
interface FULFILLMENT_ORDERS_CANCELLATION_REQUEST_SUBMITTED_fulfillment_order {
    id: string;
    status: string;
    request_status: string;
}
interface FULFILLMENT_ORDERS_CANCELLATION_REQUEST_SUBMITTED_fulfillment_order_merchant_request {
    id: string;
    message: string;
}
interface FULFILLMENT_ORDERS_CANCELLATION_REQUEST_SUBMITTED {
...
interface COMPANY_CONTACTS_UPDATE_company {
    name: string;
    note: string;
    external_id: string;
    main_contact_admin_graphql_api_id: string;
...
interface COMPANY_CONTACTS_UPDATE {
    customer_admin_graphql_api_id: string;
    title: string;
    locale: string;
    created_at: string;
...
interface SUBSCRIPTION_BILLING_ATTEMPTS_SUCCESS {
    id: null | string;
    admin_graphql_api_id: null | string;
    idempotency_key: string;
    order_id: number;
...
interface LOCALES_UPDATE {
    locale: string;
    published: boolean;
}
interface FULFILLMENT_ORDERS_RESCHEDULED_fulfillment_order {
    id: string;
    status: string;
    fulfill_at: string;
}
interface FULFILLMENT_ORDERS_RESCHEDULED {
    fulfillment_order: FULFILLMENT_ORDERS_RESCHEDULED_fulfillment_order;
}
interface SELLING_PLAN_GROUPS_UPDATE_selling_plans_billing_policy {
    interval: string;
    interval_count: number;
    min_cycles: null | string;
    max_cycles: null | string;
}
interface SELLING_PLAN_GROUPS_UPDATE_selling_plans_delivery_policy {
    interval: string;
    interval_count: number;
    anchors: Array<any>;
    cutoff: null | string;
...
interface SELLING_PLAN_GROUPS_UPDATE_selling_plans {
    name: string;
    options: Array<string>;
    position: null | string;
    description: null | string;
...
interface SELLING_PLAN_GROUPS_UPDATE {
    admin_graphql_api_id: string;
    id: number;
    name: string;
    merchant_code: string;
...
interface MARKETS_CREATE_regions {
    country_code: string;
}
interface MARKETS_CREATE {
    id: number;
    name: string;
    enabled: boolean;
    regions: Array<MARKETS_CREATE_regions>;
}
interface DRAFT_ORDERS_UPDATE_line_items {
    id: number;
    variant_id: number;
    product_id: number;
    title: string;
...
interface DRAFT_ORDERS_UPDATE_shipping_address {
    first_name: string;
    address1: string;
    phone: string;
    city: string;
...
interface DRAFT_ORDERS_UPDATE_billing_address {
    first_name: string;
    address1: string;
    phone: string;
    city: string;
...
interface DRAFT_ORDERS_UPDATE_applied_discount {
    description: string;
    value: string;
    title: string;
    amount: string;
...
interface DRAFT_ORDERS_UPDATE_shipping_line {
    title: string;
    custom: boolean;
    handle: null | string;
    price: string;
}
interface DRAFT_ORDERS_UPDATE_tax_lines {
    rate: number;
    title: string;
    price: string;
}
interface DRAFT_ORDERS_UPDATE_payment_terms_payment_schedules {
    id: number;
    created_at: string;
    updated_at: string;
    payment_terms_id: number;
...
interface DRAFT_ORDERS_UPDATE_payment_terms {
    id: number;
    payment_terms_name: string;
    payment_terms_type: string;
    due_in_days: number;
...
interface DRAFT_ORDERS_UPDATE_customer_email_marketing_consent {
    state: string;
    opt_in_level: null | string;
    consent_updated_at: null | string;
}
interface DRAFT_ORDERS_UPDATE_customer_default_address {
    id: null | string;
    customer_id: number;
    first_name: null | string;
    last_name: null | string;
...
interface DRAFT_ORDERS_UPDATE_customer {
    id: number;
    email: string;
    accepts_marketing: boolean;
    created_at: null | string;
...
interface INVENTORY_ITEMS_DELETE {
    id: number;
...
interface CUSTOMER_GROUPS_UPDATE {
    id: number;
    name: string;
    created_at: string;
    updated_at: string;
...
interface COLLECTIONS_DELETE {
    id: number;
    published_scope: string;
    admin_graphql_api_id: string;
}
interface CUSTOMERS_EMAIL_MARKETING_CONSENT_UPDATE_email_marketing_consent {
    state: null | string;
    opt_in_level: null | string;
    consent_updated_at: null | string;
}
interface CUSTOMERS_EMAIL_MARKETING_CONSENT_UPDATE {
    customer_id: number;
    email_address: null | string;
    email_marketing_consent: CUSTOMERS_EMAIL_MARKETING_CONSENT_UPDATE_email_marketing_consent;
}
interface DOMAINS_UPDATE_localization {
    country: null | string;
    default_locale: string;
    alternate_locales: Array<any>;
}
interface DOMAINS_UPDATE {
    id: number;
    host: string;
    ssl_enabled: boolean;
    localization: DOMAINS_UPDATE_localization;
}
interface INVENTORY_LEVELS_CONNECT {
    inventory_item_id: number;
    location_id: number;
...
interface FULFILLMENTS_UPDATE_destination {
    first_name: string;
    address1: string;
    phone: string;
    city: string;
...
interface FULFILLMENTS_UPDATE_line_items_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface FULFILLMENTS_UPDATE_line_items_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface FULFILLMENTS_UPDATE_line_items_price_set {
...
interface FULFILLMENTS_UPDATE_line_items_total_discount_set_shop_money {
    amount: string;
    currency_code: string;
}
interface FULFILLMENTS_UPDATE_line_items_total_discount_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface FULFILLMENTS_UPDATE_line_items_total_discount_set {
...
interface FULFILLMENTS_UPDATE_line_items {
    id: number;
    variant_id: number;
    title: string;
    quantity: number;
...
interface REFUNDS_CREATE_total_duties_set_shop_money {
    amount: string;
    currency_code: string;
}
interface REFUNDS_CREATE_total_duties_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface REFUNDS_CREATE_total_duties_set {
    shop_money: REFUNDS_CREATE_total_duties_set_shop_money;
    presentment_money: REFUNDS_CREATE_total_duties_set_presentment_money;
}
interface REFUNDS_CREATE_refund_line_items_subtotal_set_shop_money {
    amount: string;
    currency_code: string;
}
interface REFUNDS_CREATE_refund_line_items_subtotal_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface REFUNDS_CREATE_refund_line_items_subtotal_set {
...
interface REFUNDS_CREATE_refund_line_items_total_tax_set_shop_money {
    amount: string;
    currency_code: string;
}
interface REFUNDS_CREATE_refund_line_items_total_tax_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface REFUNDS_CREATE_refund_line_items_total_tax_set {
...
interface REFUNDS_CREATE_refund_line_items_line_item_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface REFUNDS_CREATE_refund_line_items_line_item_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface REFUNDS_CREATE_refund_line_items_line_item_price_set {
...
interface REFUNDS_CREATE_refund_line_items_line_item_total_discount_set_shop_money {
    amount: string;
    currency_code: string;
}
interface REFUNDS_CREATE_refund_line_items_line_item_total_discount_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface REFUNDS_CREATE_refund_line_items_line_item_total_discount_set {
...
interface REFUNDS_CREATE_refund_line_items_line_item {
    id: number;
    variant_id: number;
    title: string;
    quantity: number;
...
interface REFUNDS_CREATE_refund_line_items {
    id: number;
    quantity: number;
    line_item_id: number;
    location_id: null | string;
...
interface PRODUCTS_UPDATE_variants {
    admin_graphql_api_id: string;
    barcode: null | string;
    compare_at_price: string;
    created_at: null | string;
...
interface CUSTOMER_PAYMENT_METHODS_REVOKE_payment_instrument {
    last_digits: string;
    month: number;
    year: number;
    name: string;
...
interface CUSTOMER_PAYMENT_METHODS_REVOKE {
    admin_graphql_api_id: string;
    token: string;
    customer_id: number;
    admin_graphql_api_customer_id: string;
...
interface PROFILES_UPDATE {
    id: number;
}
interface COLLECTION_LISTINGS_UPDATE_collection_listing {
    collection_id: number;
    updated_at: null | string;
    body_html: string;
    default_product_image: null | string;
...
interface COLLECTION_LISTINGS_UPDATE {
    collection_listing: COLLECTION_LISTINGS_UPDATE_collection_listing;
}
interface THEMES_DELETE {
    id: number;
}
interface SUBSCRIPTION_CONTRACTS_UPDATE_billing_policy {
    interval: string;
    interval_count: number;
    min_cycles: number;
    max_cycles: number;
}
interface SUBSCRIPTION_CONTRACTS_UPDATE_delivery_policy {
    interval: string;
    interval_count: number;
}
interface SUBSCRIPTION_CONTRACTS_UPDATE {
    admin_graphql_api_id: string;
    id: number;
...
interface COMPANY_CONTACTS_DELETE_company {
    name: string;
    note: string;
    external_id: string;
    main_contact_admin_graphql_api_id: string;
...
interface COMPANY_CONTACTS_DELETE {
    customer_admin_graphql_api_id: string;
    title: string;
    locale: string;
    created_at: string;
...
interface BULK_OPERATIONS_FINISH {
    admin_graphql_api_id: string;
    completed_at: string;
    created_at: string;
    error_code: null | string;
...
interface SUBSCRIPTION_BILLING_CYCLE_EDITS_UPDATE {
    subscription_contract_id: number;
    cycle_start_at: string;
    cycle_end_at: string;
    cycle_index: number;
...
interface FULFILLMENT_EVENTS_DELETE {
    id: number;
    fulfillment_id: number;
    status: string;
    message: string;
...
interface PRODUCT_LISTINGS_UPDATE_product_listing_variants_option_values {
    option_id: number;
    name: string;
    value: string;
}
interface PRODUCT_LISTINGS_UPDATE_product_listing_variants {
    id: number;
    title: string;
...
interface PRODUCT_LISTINGS_UPDATE_product_listing_images {
    id: number;
    created_at: null | string;
    position: number;
    updated_at: null | string;
...
interface PRODUCT_LISTINGS_UPDATE_product_listing_options {
    id: number;
    name: string;
    product_id: number;
    position: number;
...
interface PRODUCT_LISTINGS_UPDATE_product_listing {
    product_id: number;
    created_at: null | string;
    updated_at: string;
    body_html: string;
...
interface PRODUCT_LISTINGS_UPDATE {
    product_listing: PRODUCT_LISTINGS_UPDATE_product_listing;
}
interface CUSTOMER_GROUPS_DELETE {
    id: number;
}
interface INVENTORY_ITEMS_UPDATE {
    id: number;
    sku: string;
    created_at: string;
    updated_at: string;
...
interface CARTS_UPDATE_line_items_discounted_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface CARTS_UPDATE_line_items_discounted_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface CARTS_UPDATE_line_items_discounted_price_set {
...
interface CARTS_UPDATE_line_items_line_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface CARTS_UPDATE_line_items_line_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface CARTS_UPDATE_line_items_line_price_set {
...
interface CARTS_UPDATE_line_items_original_line_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface CARTS_UPDATE_line_items_original_line_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface CARTS_UPDATE_line_items_original_line_price_set {
...
interface CARTS_UPDATE_line_items_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface CARTS_UPDATE_line_items_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface CARTS_UPDATE_line_items_price_set {
...
interface CARTS_UPDATE_line_items_total_discount_set_shop_money {
    amount: string;
    currency_code: string;
}
interface CARTS_UPDATE_line_items_total_discount_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface CARTS_UPDATE_line_items_total_discount_set {
...
interface CARTS_UPDATE_line_items {
    id: number;
...
interface DRAFT_ORDERS_DELETE_payment_terms_payment_schedules {
    id: number;
    created_at: string;
    updated_at: string;
    payment_terms_id: number;
...
interface DRAFT_ORDERS_DELETE_payment_terms {
    id: number;
    payment_terms_name: string;
    payment_terms_type: string;
    due_in_days: number;
...
interface DRAFT_ORDERS_DELETE {
    id: number;
    payment_terms: DRAFT_ORDERS_DELETE_payment_terms;
    admin_graphql_api_id: string;
}
interface SELLING_PLAN_GROUPS_DELETE {
    admin_graphql_api_id: string;
    id: number;
}
interface COMPANY_LOCATIONS_CREATE_company {
    name: string;
    note: string;
    external_id: string;
    main_contact_admin_graphql_api_id: string;
...
interface COMPANY_LOCATIONS_CREATE_billing_address {
    address1: string;
    city: string;
    province: string;
    country: string;
...
interface COMPANY_LOCATIONS_CREATE_shipping_address {
    address1: string;
    city: string;
    province: string;
    country: string;
...
interface COMPANY_LOCATIONS_CREATE_tax_registration {
    tax_id: string;
}
interface COMPANY_LOCATIONS_CREATE {
    name: string;
    external_id: string;
    phone: string;
    locale: string;
...
interface PRODUCT_FEEDS_CREATE {
    id: string;
    country: string;
    language: string;
    status: string;
}
interface TENDER_TRANSACTIONS_CREATE {
    id: number;
    order_id: number;
    amount: string;
    currency: string;
...
interface PRODUCT_FEEDS_INCREMENTAL_SYNC_metadata {
    action: string;
    type: string;
    resource: string;
    truncatedFields: Array<any>;
...
interface PRODUCT_FEEDS_INCREMENTAL_SYNC_productFeed {
    id: string;
    shop_id: string;
    language: string;
    country: string;
}
interface PRODUCT_FEEDS_INCREMENTAL_SYNC_product_images_edges_node {
    id: string;
    url: string;
    height: number;
    width: number;
}
interface PRODUCT_FEEDS_INCREMENTAL_SYNC_product_images_edges {
    node: PRODUCT_FEEDS_INCREMENTAL_SYNC_product_images_edges_node;
}
interface PRODUCT_FEEDS_INCREMENTAL_SYNC_product_images {
    edges: Array<PRODUCT_FEEDS_INCREMENTAL_SYNC_product_images_edges>;
}
interface PRODUCT_FEEDS_INCREMENTAL_SYNC_product_options {
    name: string;
    values: Array<string>;
}
interface PRODUCT_FEEDS_INCREMENTAL_SYNC_product_variants_edges_node_price {
    amount: string;
    currencyCode: string;
}
interface PRODUCT_FEEDS_INCREMENTAL_SYNC_product_variants_edges_node_selectedOptions {
    name: string;
    value: string;
}
interface PRODUCT_FEEDS_INCREMENTAL_SYNC_product_variants_edges_node {
    id: string;
    title: string;
...
interface PRODUCT_FEEDS_INCREMENTAL_SYNC_product_variants_edges {
    node: PRODUCT_FEEDS_INCREMENTAL_SYNC_product_variants_edges_node;
}
interface PRODUCT_FEEDS_INCREMENTAL_SYNC_product_variants {
    edges: Array<PRODUCT_FEEDS_INCREMENTAL_SYNC_product_variants_edges>;
}
interface PRODUCT_FEEDS_INCREMENTAL_SYNC_product_seo {
    title: string;
    description: string;
}
interface PRODUCT_FEEDS_INCREMENTAL_SYNC_product_metafields {
    namespace: string;
    key: string;
    value: string;
    type: string;
}
interface PRODUCT_FEEDS_INCREMENTAL_SYNC_product {
    id: string;
    title: string;
    description: string;
...
interface PRODUCT_FEEDS_INCREMENTAL_SYNC {
...
interface SUBSCRIPTION_BILLING_ATTEMPTS_FAILURE {
    id: null | string;
    admin_graphql_api_id: null | string;
    idempotency_key: string;
    order_id: number;
...
interface ORDERS_DELETE {
    id: number;
}
interface FULFILLMENT_ORDERS_FULFILLMENT_REQUEST_ACCEPTED_fulfillment_order {
    id: string;
    status: string;
    request_status: string;
}
interface FULFILLMENT_ORDERS_FULFILLMENT_REQUEST_ACCEPTED {
    fulfillment_order: FULFILLMENT_ORDERS_FULFILLMENT_REQUEST_ACCEPTED_fulfillment_order;
    message: string;
}
interface FULFILLMENT_ORDERS_LINE_ITEMS_PREPARED_FOR_LOCAL_DELIVERY_fulfillment_order_delivery_method {
    method_type: string;
}
interface FULFILLMENT_ORDERS_LINE_ITEMS_PREPARED_FOR_LOCAL_DELIVERY_fulfillment_order {
    id: string;
    status: string;
    preparable: boolean;
    delivery_method: FULFILLMENT_ORDERS_LINE_ITEMS_PREPARED_FOR_LOCAL_DELIVERY_fulfillment_order_delivery_method;
}
interface FULFILLMENT_ORDERS_LINE_ITEMS_PREPARED_FOR_LOCAL_DELIVERY {
    fulfillment_order: FULFILLMENT_ORDERS_LINE_ITEMS_PREPARED_FOR_LOCAL_DELIVERY_fulfillment_order;
}
interface PRODUCTS_CREATE_variants {
    admin_graphql_api_id: string;
    barcode: null | string;
    compare_at_price: string;
    created_at: null | string;
...
interface ORDERS_CANCELLED_current_subtotal_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_current_subtotal_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_current_subtotal_price_set {
...
interface ORDERS_CANCELLED_current_total_discounts_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_current_total_discounts_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_current_total_discounts_set {
...
interface ORDERS_CANCELLED_current_total_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_current_total_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_current_total_price_set {
...
interface ORDERS_CANCELLED_current_total_tax_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_current_total_tax_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_current_total_tax_set {
...
interface ORDERS_CANCELLED_subtotal_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_subtotal_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_subtotal_price_set {
...
interface ORDERS_CANCELLED_total_discounts_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_total_discounts_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_total_discounts_set {
...
interface ORDERS_CANCELLED_total_line_items_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_total_line_items_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_total_line_items_price_set {
...
interface ORDERS_CANCELLED_total_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_total_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_total_price_set {
...
interface ORDERS_CANCELLED_total_shipping_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_total_shipping_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_total_shipping_price_set {
...
interface ORDERS_CANCELLED_total_tax_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_total_tax_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_total_tax_set {
    shop_money: ORDERS_CANCELLED_total_tax_set_shop_money;
    presentment_money: ORDERS_CANCELLED_total_tax_set_presentment_money;
}
interface ORDERS_CANCELLED_billing_address {
    first_name: string;
    address1: string;
    phone: string;
    city: string;
...
interface ORDERS_CANCELLED_customer_email_marketing_consent {
    state: string;
    opt_in_level: null | string;
    consent_updated_at: null | string;
}
interface ORDERS_CANCELLED_customer_default_address {
    id: number;
    customer_id: number;
    first_name: null | string;
    last_name: null | string;
...
interface ORDERS_CANCELLED_customer {
    id: number;
    email: string;
    accepts_marketing: boolean;
    created_at: null | string;
...
interface ORDERS_CANCELLED_line_items_attributed_staffs {
    id: string;
    quantity: number;
}
interface ORDERS_CANCELLED_line_items_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_line_items_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_line_items_price_set {
...
interface ORDERS_CANCELLED_line_items_total_discount_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_line_items_total_discount_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_line_items_total_discount_set {
...
interface ORDERS_CANCELLED_line_items {
    id: number;
    admin_graphql_api_id: string;
...
interface ORDERS_CANCELLED_shipping_address {
    first_name: string;
    address1: string;
    phone: string;
    city: string;
...
interface ORDERS_CANCELLED_shipping_lines_discounted_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_shipping_lines_discounted_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_shipping_lines_discounted_price_set {
...
interface ORDERS_CANCELLED_shipping_lines_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_shipping_lines_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface ORDERS_CANCELLED_shipping_lines_price_set {
...
interface ORDERS_CANCELLED_shipping_lines {
    id: number;
    carrier_identifier: null | string;
    code: null | string;
    discounted_price: string;
...
interface INVENTORY_LEVELS_UPDATE {
    inventory_item_id: number;
    location_id: number;
    available: null | string;
    updated_at: string;
...
interface PROFILES_CREATE {
    id: number;
}
interface THEMES_PUBLISH {
    id: number;
    name: string;
    created_at: string;
    updated_at: string;
...
interface PRODUCT_LISTINGS_ADD_product_listing_variants_option_values {
    option_id: number;
    name: string;
    value: string;
}
interface PRODUCT_LISTINGS_ADD_product_listing_variants {
    id: number;
    title: string;
...
interface PRODUCT_LISTINGS_ADD_product_listing_images {
    id: number;
    created_at: null | string;
    position: number;
    updated_at: null | string;
...
interface PRODUCT_LISTINGS_ADD_product_listing_options {
    id: number;
    name: string;
    product_id: number;
    position: number;
...
interface PRODUCT_LISTINGS_ADD_product_listing {
    product_id: number;
    created_at: null | string;
    updated_at: string;
    body_html: string;
...
interface PRODUCT_LISTINGS_ADD {
    product_listing: PRODUCT_LISTINGS_ADD_product_listing;
}
interface SUBSCRIPTION_CONTRACTS_CREATE_billing_policy {
    interval: string;
    interval_count: number;
    min_cycles: number;
    max_cycles: number;
}
interface SUBSCRIPTION_CONTRACTS_CREATE_delivery_policy {
    interval: string;
    interval_count: number;
}
interface SUBSCRIPTION_CONTRACTS_CREATE {
    admin_graphql_api_id: string;
    id: number;
...
interface SUBSCRIPTION_BILLING_CYCLE_EDITS_CREATE {
    subscription_contract_id: number;
    cycle_start_at: string;
    cycle_end_at: string;
    cycle_index: number;
...
interface PRODUCT_LISTINGS_REMOVE_product_listing {
    product_id: number;
}
interface PRODUCT_LISTINGS_REMOVE {
    product_listing: PRODUCT_LISTINGS_REMOVE_product_listing;
}
interface MARKETS_DELETE {
    id: number;
}
type CARTS_CREATE_line_items_properties = Object;
interface CARTS_CREATE_line_items_discounted_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface CARTS_CREATE_line_items_discounted_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface CARTS_CREATE_line_items_discounted_price_set {
...
interface CARTS_CREATE_line_items_line_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface CARTS_CREATE_line_items_line_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface CARTS_CREATE_line_items_line_price_set {
...
interface CARTS_CREATE_line_items_original_line_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface CARTS_CREATE_line_items_original_line_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface CARTS_CREATE_line_items_original_line_price_set {
...
interface CARTS_CREATE_line_items_price_set_shop_money {
    amount: string;
    currency_code: string;
}
interface CARTS_CREATE_line_items_price_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface CARTS_CREATE_line_items_price_set {
...
interface CARTS_CREATE_line_items_total_discount_set_shop_money {
    amount: string;
    currency_code: string;
}
interface CARTS_CREATE_line_items_total_discount_set_presentment_money {
    amount: string;
    currency_code: string;
}
interface CARTS_CREATE_line_items_total_discount_set {
...
interface CARTS_CREATE_line_items {
    id: number;
...
interface INVENTORY_ITEMS_CREATE {
    id: number;
    sku: string;
    created_at: string;
    updated_at: string;
...
interface FULFILLMENT_ORDERS_ORDER_ROUTING_COMPLETE_fulfillment_order {
    id: string;
    status: string;
}
interface FULFILLMENT_ORDERS_ORDER_ROUTING_COMPLETE {
    fulfillment_order: FULFILLMENT_ORDERS_ORDER_ROUTING_COMPLETE_fulfillment_order;
}
interface APP_UNINSTALLED {
    id: number;
    name: string;
    email: string;
    domain: null | string;
...
interface FULFILLMENT_ORDERS_SCHEDULED_FULFILLMENT_ORDER_READY_fulfillment_order {
    id: string;
    status: string;
}
interface FULFILLMENT_ORDERS_SCHEDULED_FULFILLMENT_ORDER_READY {
    fulfillment_order: FULFILLMENT_ORDERS_SCHEDULED_FULFILLMENT_ORDER_READY_fulfillment_order;
}
interface COMPANY_LOCATIONS_UPDATE_company {
    name: string;
    note: string;
    external_id: string;
    main_contact_admin_graphql_api_id: string;
...
interface COMPANY_LOCATIONS_UPDATE_billing_address {
    address1: string;
    city: string;
    province: string;
    country: string;
...
interface COMPANY_LOCATIONS_UPDATE_shipping_address {
    address1: string;
    city: string;
    province: string;
    country: string;
...
interface COMPANY_LOCATIONS_UPDATE_tax_registration {
    tax_id: string;
}
interface COMPANY_LOCATIONS_UPDATE {
    name: string;
    external_id: string;
    phone: string;
    locale: string;
...
interface FULFILLMENT_ORDERS_CANCELLATION_REQUEST_ACCEPTED_fulfillment_order {
    id: string;
    status: string;
}
interface FULFILLMENT_ORDERS_CANCELLATION_REQUEST_ACCEPTED {
    fulfillment_order: FULFILLMENT_ORDERS_CANCELLATION_REQUEST_ACCEPTED_fulfillment_order;
    message: string;
}
interface CUSTOMERS_MARKETING_CONSENT_UPDATE_sms_marketing_consent {
    state: null | string;
    opt_in_level: null | string;
    consent_updated_at: null | string;
    consent_collected_from: string;
}
interface CUSTOMERS_MARKETING_CONSENT_UPDATE {
    id: number;
    phone: null | string;
    sms_marketing_consent: CUSTOMERS_MARKETING_CONSENT_UPDATE_sms_marketing_consent;
}
interface LOCATIONS_UPDATE {
    id: number;
    name: string;
    address1: string;
    address2: string;
...
interface COLLECTION_LISTINGS_REMOVE_collection_listing {
    collection_id: number;
}
interface COLLECTION_LISTINGS_REMOVE {
    collection_listing: COLLECTION_LISTINGS_REMOVE_collection_listing;
}
interface FULFILLMENT_ORDERS_CANCELLED_fulfillment_order {
    id: string;
    status: string;
}
interface FULFILLMENT_ORDERS_CANCELLED_replacement_fulfillment_order {
    id: string;
    status: string;
}
interface FULFILLMENT_ORDERS_CANCELLED {
